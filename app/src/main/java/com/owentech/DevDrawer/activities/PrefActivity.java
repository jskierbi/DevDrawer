...
public class PrefActivity extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final CheckBoxPreference checkBoxPreference = (CheckBoxPreference) findPreference("flgEnableSync");
		final EditTextPreference urlTextPreference = (EditTextPreference) findPreference("syncUrl");
		...
		urlTextPreference.setSummary(sp.getString("syncUrl", "empty"));
		urlTextPreference.setEnabled(sp.getBoolean("flgEnableSync", false));

		checkBoxPreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
			@Override public boolean onPreferenceChange(Preference preference, Object newValue) {
				boolean flgEnabled = (Boolean) newValue;
				urlTextPreference.setEnabled(flgEnabled);
				return true;
			}
		});

		urlTextPreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
			@Override public boolean onPreferenceChange(Preference preference, Object newValue) {
				String urlStr = (String) newValue;
				try {
					new URL(urlStr);
					preference.setSummary(urlStr);
					return true;
				} catch (Exception ex) {
					Toast.makeText(PrefActivity.this, "Invalid URL!", Toast.LENGTH_SHORT).show();
					return false;
				}
			}
		});
